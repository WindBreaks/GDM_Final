namespace Assignment
{
    public class AssignmentConfig
    {
        ...
        /// </summary>  
        public const string AssignmentName = "Assignment 10";

        /// <summary>
        /// Description of the assignment.
        /// </summary>
        public const string AssignmentDescription = "Midterm #2 Sec ABCD";

        public const string AssignmentResourceID = "bu.2025.sem-1.gi262.as10";
